/**
 * Actual Game Board in the game where the players place their dominos.
...
public class GameBoard {
    ...
    public boolean findMatch(Domino domino){
        boolean isMatchLeft = domino.isMatchLeft(this.getBoard().getFirst());
        boolean isMatchRight = domino.isMatchRight(this.getBoard().getLast());
