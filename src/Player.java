/**
 * Player in the game with its functionalities.
...
public class Player {
    ...
    public void play(Domino domino, GameBoard board, String place, String rotate){
        if(board.getBoard().isEmpty() || board.findMatch(domino) || domino.isWild()){
            ...
            if(place.equals("l")){
                System.out.printf("Playing [%d %d] at left\n", domino.getLeft(), domino.getRight());
                board.getBoard().addFirst(domino);
            }
            else{
                System.out.printf("Playing [%d %d] at Right\n", domino.getLeft(), domino.getRight());
    ...
    /**
     * lookTray - prints the players hands
     */
    public void lookTray(){
        System.out.print("Tray: ");
        System.out.print("[");
        for(Domino i: hands){
            System.out.printf(" [ %d %d ] ",i.getLeft(),i.getRight());
        }
        System.out.print("]\n");
    }
    ...
    public void autoPlay(GameBoard board, Boneyard boneyard){
        ...
        while(!found){
            ...
            if(index < this.hands.size()) {
                ...
                if (domino.isWild()) {
                    System.out.printf("Computer plays [%d %d] at Right\n", domino.getLeft(), domino.getRight());
                    found = true;
                    this.getHands().remove(domino);
                    board.getBoard().addLast(domino);
    ...
    private void checkBoardLeft(Domino domino, GameBoard board){
        System.out.printf("Computer plays [%d %d] at left\n", domino.getLeft(), domino.getRight());
